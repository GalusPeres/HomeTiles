...
static const Strings kStringsPl = {
    "pl",
    "pl",
    "Język:",
    "Strefa czasowa:",
    ...
    "Waveshare Admin",
    "Panel administracyjny Waveshare",
    "Konfiguracja i przegląd",
    "Kliknij kafelek, aby go edytować. Przeciągaj i upuszczaj kafelki, aby je przenosić, lub użyj narożnego uchwytu, aby zmieniać rozmiar. Wybierz typ i dostosuj ustawienia.",
    "Usuń folder / zakładkę",
    "Ustawienia kafelka",
    "Typ",
    ...
    "Wklej",
    "Usuń",
    "Import / eksport (wszystkie foldery i kafelki)",
    "Eksport",
    "Import",
    "Import nadpisuje dołączone foldery/kafelki i, jeśli obecny, wygaszacz ekranu.",
    "WiFi",
    "MQTT",
    "Lokalizacja",
    "Zrzut ekranu & diagnostyka",
    "Aktualizacja oprogramowania",
    "Utwórz i pobierz zrzut ekranu",
    "Zapisuje /ui_screenshot.jpg na karcie microSD. Istniejący plik zostanie nadpisany.",
    "Plik oprogramowania",
    "Aktualna wersja",
    "Aktualizuj",
    "Tutaj przesyłaj tylko plik update.bin. Plik factory.bin służy tylko do pierwszego flashowania.",
    "Wybierz plik",
    "Nie wybrano pliku",
    ...
    "Maska podsieci",
    "Serwer DNS",
    "Pozostaw puste dla DHCP",
    "MQTT nie skonfigurowano",
    "Włącz AP",
    "Wyłącz AP",
    "Tak",
    "Nie",
    ...
    "ID klienta MQTT",
    "puste = automatyczne",
    "Pozostaw puste, aby wygenerować automatycznie z adresu MAC.",
    "Bazowy temat urządzenia",
    "Prefiks Home Assistant",
    "Rozmiar czcionki czasu",
    "Rozmiar czcionki daty",
    "Zapisz",
    "Czy na pewno zrestartować urządzenie?",
    "Restart",
    "Konfiguracja MQTT zapisana",
    "Urządzenie ponownie się łączy ...",
    "Konfiguracja mostu zapisana",
    "Dane zostały przesłane przez MQTT.",
    "Zapisywanie nie powiodło się",

    "Konfiguracja WiFi Waveshare",
    "Konfiguracja WiFi",
    "Krok 1: Połącz z WiFi",
    "Połączenie WiFi",
    "SSID (nazwa sieci)",
    "Moje WiFi",
    "Hasło",
    "Hasło",
    "Pozostaw puste dla otwartej sieci",
    "Uwaga:",
    "Po nawiązaniu połączenia WiFi możesz skonfigurować ustawienia MQTT przez interfejs webowy w zwykłej sieci.",
    "Zapisz i połącz",
    "Zapisano pomyślnie!",
    "Konfiguracja została pomyślnie zapisana.<br>Urządzenie zostanie teraz uruchomione ponownie i spróbuje połączyć się z WiFi.",
    "Zostaniesz automatycznie przekierowany za 10 sekund.<br>Jeśli połączenie się nie powiedzie, włącz ponownie tryb hotspotu z ustawień.",
    "Błąd: SSID WiFi jest wymagany!",
    ...
    "Maks wskaźnika",
    "Stopnie łuku (90-359)",
    "Rozmiar wskaźnika (100-800 px)",
    "Przesunięcie Y (-100 do 200)",
    "Wysokość wykresu (20-200 px)",
    "Otwórz popup",
    "Krótkie naciśnięcie",
    "Długie naciśnięcie",
    "Przesunięcie Y wartości (-100 do 200)",
    "Encja pogody",
    "Encja energii",
    "Przełącznik / Światło",
    "Wyświetlanie",
    ...
    "Kafelek skopiowany",
    "Brak skopiowanego kafelka",
    "Kafelek wklejony",
    "Kafelek Ustawienia (stały)",
    "Kafelek Wstecz (stały)",
    "Tego kafelka nie można usunąć",
    "Tego folderu nie można usunąć",
    "Usunąć folder \"{name}\"?\n\nWszystkie kafelki w tym folderze zostaną usunięte, a kafelek folderu w folderze nadrzędnym zostanie usunięty.",
    "Folder usunięty",
    "Usunięcie nie powiodło się",
    "Nie znaleziono folderu",
    "Kafelek zapisany i wyświetlacz zaktualizowany!",
    "Nieznany",
    "Błąd sieci",
    "Błąd sieci podczas zapisywania",
    "Eksport utworzony!",
    "Eksport nie powiódł się",
    "Nieprawidłowy JSON importu",
    "Import nie powiódł się",
    "Trwa import...",
    "Import zakończony!",
    "Kafelek nie pasuje w to miejsce",
    ...
    "Zrzut ekranu nie powiódł się",
    "Najpierw wybierz plik update.bin",
    ...
    "Wstecz",
    "Połącz",
    "Zapisano – urządzenie restartuje się...",
    "Zapisywanie nie powiodło się",

    "Klawiatura:",

    "Jasność, czuwanie i obrót",
    "Sieć i punkt dostępu",
    "Język, strefa czasowa i klawiatura",
    "%s",
    ...
    "Dostępna aktualizacja %s",
    "Możliwe dwa restarty. Następnie sprawdź wersję.",
    "Aktualizuj do %s",
    "Sprawdzanie nie powiodło się",
    "Pobieranie aktualizacji...",
    "Aktualizacja nie powiodła się",
    "Zainstalowano! Restartowanie...",

    "Rozłącz",
    "Parowanie",
    "Parowanie: ponowne łączenie MQTT...",
    ...
    "Wymagana karta microSD: utwórz folder /images w katalogu głównym karty i umieść tam obrazy JPEG.",
    "Brak plików JPEG w /images – czarne tło pozostaje aktywne.",
    "Wygaszacz ekranu zapisany!",
    "Nie udało się zapisać wygaszacza ekranu",
    "Nie udało się załadować wygaszacza ekranu",

    "Włącz Ethernet",
    "Włącz WiFi",
    "Tryb sieciowy zmieniony – aktywny po restarcie",
    "Ethernet zamiast WiFi (aktywny po restarcie)",

    "Użyj DHCP",
    "Cofnij DHCP",
    "DHCP wybrane – aktywne po restarcie",
    "Statyczny adres IP wybrany – aktywny po restarcie",
    "Konfiguracja IP",
    "DHCP (automatyczne)",
    "Statyczny adres IP",
    "DHCP jest wybrane. Adres zostanie przypisany automatycznie po zapisaniu i restarcie.",
    "Wymagane: statyczny adres IP, brama i maska podsieci. DNS jest opcjonalny. Jeśli brakuje wartości lub jest nieprawidłowa, zostanie użyte DHCP. Aktywne po zapisaniu i restarcie.",
    "Konfiguracja statycznego adresu IP jest niekompletna lub nieprawidłowa.",
    ...
    "Sieć",
    "Typ połączenia",
    "Typ połączenia jest używany po restarcie.",
    "Użyj statycznego adresu IP",

    "Pokaż",
    "Ukryj",

    "Pobierz dziennik awarii",
    "Otwórz diagnostykę SD",
    "Zapisany zrzut pamięci",
    "Pobierz zrzut pamięci",
    "Usuń zrzut pamięci",
    "Zdekoduj zrzut pamięci na komputerze za pomocą esp-coredump i pliku ELF kompilacji, aby uzyskać pełny ślad stosu.",
    ...
    "Strumień zatrzymany",
    "Pusty adres URL strumienia",
    "Strumień kamery już działa",
    "Nie można uruchomić zadania kamery",
    "Za mało pamięci PSRAM dla klatki wideo",
    "Błąd dekodera JPEG",
    "Łączenie z kamerą",
    "Nie można otworzyć adresu URL strumienia",
    "Nie można uruchomić dekodera JPEG",
    "Za mało pamięci PSRAM dla bufora strumienia",
    "Buforowanie ...",
    "Połączenie ze strumieniem zakończone",
    "Nieoczekiwana rozdzielczość wideo (%u bajtów)",
    "Błąd HTTP %d",
    "Wideo kamery dostępne tylko na Waveshare 8 cali",
    "Nieznana kamera",
    "Obraz kamery niedostępny",
    "Adres URL Home Assistant niedostępny",
    "Konfiguracja strumienia kamery nie powiodła się",
    "Bufor wejściowy JPEG pełny",
    "%.1f FPS",
    "MQTT rozłączono",
    "Brak tematu kamery",
    "Kolejka MQTT pełna",
    ...
    "Usuń przypisanie",
    "Usunąć \"{name}\"?",
    "Brak przypisań lokalnych I/O. Dodaj przełącznik lub czujnik temperatury powyżej.",
    "To urządzenie nie ma jeszcze zweryfikowanego konfigurowalnego profilu GPIO.",
    "Niezapisane zmiany",
    "Brak wolnego kompatybilnego GPIO",
    "Nazwa jest wymagana",
    "Zapisywanie…",
    "Zapisano",
    "Ładowanie nie powiodło się",
    "Nie udało się załadować przypisań I/O.",
    "Niezapisane zmiany I/O zostaną utracone. Zrestartować urządzenie?",
    "Restartowanie…",
    ...
    "4 do 8 cyfr",
    "PIN zapisany.",
    "Nie skonfigurowano jeszcze PIN-u.",
    "Otwórz gestem od krawędzi",
    "Krawędź gestu",
    "Przesuń w kierunku środka od wybranej krawędzi. Działa to również, gdy kafelek jest widoczny.",
    "Lewo",
    "Prawo",
    "Góra",
    "Dół",
    "PIN fabryczny",
    "Dłuższy PIN fabryczny odblokowuje Ustawienia i chronione foldery. To lokalna blokada dla dzieci, a nie logowanie.",
    "Najpierw zwolnij jedną komórkę w Stronie głównej, aby można było przywrócić kafelek Ustawienia.",
    "PIN musi zawierać od 4 do 8 cyfr.",
    "Chroń ten folder PIN-em",
    "PIN",
    "4 do 8 cyfr",
    "Zastosuj PIN",
    "PIN folderu zapisany",
    "Nie można zapisać PIN-u folderu",
    "Najpierw zapisz nowy kafelek folderu.",
    "Odblokuj Ustawienia",
    "Nieprawidłowy PIN",
    "Odblokuj %s",
    "Upuść tutaj Ustawienia, aby ukryć kafelek.",
    "Kamera wbudowana",
    "Zezwól Home Assistant na używanie kamery wbudowanej",
    "Wyłączone domyślnie. Gdy włączone, wyświetlacz zapisuje pojedyncze zdjęcia lub strumień na żywo tylko wtedy, gdy Home Assistant Bridge żąda ich przez MQTT. Gdy wyłączone, czujnik pozostaje w trybie gotowości programowej; ta płyta nie ma przełącznika sprzętowego, który odcina zasilanie kamery.",
    "Status",
    "Wyłączone",
    "Sprawdzanie czujnika...",
    "Wykryto czujnik",
    "Nie znaleziono czujnika kamery",
    "Błąd kamery",
    "Tryb",
    "Auto (most)",
    "Lustrzane odbicie",
    ...
    "Pokaż czerwoną linię na górze",
    "Pokaż przycisk do zakończenia strumienia",
    "Czerwona linia na wyświetlaczu wskazuje, że kamera nagrywa. Pudełko kończy strumień na żywo bezpośrednio na wyświetlaczu.",
    "Niestandardowe",
    "Klatki na sekundę",
    "Jakość JPEG",
    "Wskaźnik nagrywania (eksperymentalne)",
    "Strumień na żywo",
    "Maks. wzmocnienie"};
...
static const LocaleProfile kLocalePl = {
    ...
    {"Czysta noc", "Pochmurno", "Wyjątkowe", "Mgła", "Grad",
     "Burza", "Burza z deszczem", "Częściowo pochmurno", "Ulewny deszcz",
     "Deszcz", "Śnieg", "Deszcz ze śniegiem", "Słonecznie", "Wietrznie", "Porywisty wiatr"},
    "Klimatyzacja",
    "Encja klimatyzacji",
    ...
    {"Brak", "Eko", "Nieobecny", "Wzmocnienie", "Komfort", "Dom", "Sen",
     "Aktywność", "Auto", "Niski", "Średni", "Wysoki", "Włączone", "Wyłączone",
     "Góra", "Środek", "Skupiony", "Rozproszony", "Pionowy", "Poziomy",
     "Oba", "Lewy", "Środek", "Prawy", "Oscylacja", "Szeroki"},
    {"Automatyczny", "Pusty", "Pusty / usuń", "Puste pole",
    ...
    {"Global", "Europa", "Ameryki", "Afryka i Bliski Wschód", "Azja",
     "Oceania"},
    {"UTC+0 - UTC",
     "UTC+0 / UTC+1 - Londyn",
     "UTC+1 / UTC+2 - Berlin",
