...
static const Strings kStringsDe = {
    ...
    "Kachel-Schatten",
    "Kachelradius",
    "Für andere Kacheltypen zuerst eine ganze Größe wählen.",
    "Kachel-Rahmen",
    "Deckkraft",
...
static const Strings kStringsEn = {
    ...
    "Tile shadows",
    "Tile radius",
    "Choose a whole-cell size before switching to another tile type.",
    "Tile borders",
    "Opacity",
...
static const Strings kStringsFr = {
    ...
    "Ombre des tuiles",
    "Rayon des tuiles",
    "Choisissez une taille entière avant de changer de type de tuile.",
    "Bordure des tuiles",
    "Opacité",
