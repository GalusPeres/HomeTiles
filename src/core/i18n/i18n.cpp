...
static const Strings kStringsDe = {
    ...
    "Regel hinzufügen",
    "Entfernen",
    "Die erste passende Regel gilt. Ohne Treffer gilt die Icon-Farbe, sonst die Standardfarbe. Nicht verfügbare Zustände behalten die Standardfarbe.",
    "Deckkraft",
...
static const Strings kStringsEn = {
    ...
    "Add rule",
    "Remove",
    "The first matching rule wins. Without a match the icon color applies, otherwise the default color. Unavailable states keep the default color.",
    "Opacity",
...
static const Strings kStringsFr = {
    ...
    "Ajouter une règle",
    "Supprimer",
    "La première règle correspondante s'applique. Sans correspondance, la couleur de l'icône s'applique, sinon la couleur par défaut. Les états indisponibles gardent la couleur par défaut.",
    "Opacité",
