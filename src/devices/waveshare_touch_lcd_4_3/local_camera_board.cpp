#include "src/devices/waveshare_touch_lcd_4_3/local_camera_board.h"

#if defined(DEVICE_WAVESHARE_TOUCH_LCD_4_3) && defined(HOMETILES_LOCAL_CAMERA)
...
local_camera::BoardError acquire(i2c_master_bus_handle_t* sccb_bus) {
  ...
  i2c_master_bus_handle_t bus = DeviceWaveshareTouchLCD4_3::sharedI2cBus();
...
#endif  // defined(DEVICE_WAVESHARE_TOUCH_LCD_4_3) && defined(HOMETILES_LOCAL_CAMERA)
